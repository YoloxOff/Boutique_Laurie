  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <div className="prose prose-neutral mt-8 max-w-none text-sm text-muted-foreground">
        <p>
          Laurie Coiffure collecte et traite des données personnelles (identité, contact, historique
          de commande) dans le cadre de la gestion de la relation client et des ventes en ligne,
