        ...
        {typeof page.content === "string" && page.content ? (
          ...
          <>
            <p>
              ...
              réalisées sur le site {"laurie-coiffure.fr"}. Contenu à finaliser avec
              l&apos;équipe juridique du salon avant mise en production (moyens de paiement,
              délais de rétractation, garanties, litiges) — modifiable depuis l&apos;admin
              (Paramètres).
            </p>
